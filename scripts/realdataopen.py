...
def get_adult_data(target: str, seed: int):
    ...
    return original_train, original_val, original_test, original_train[target], original_val[target],\
        original_test[target], categorical
...
def get_german_data(target: str, seed: int):
    ...
    original_train, original_val, original_test = split_dataset(original, seed)
    return original_train, original_val, original_test, original_train[target].reset_index(drop=True),\
